package com.yuntuan.server.util;
...
public class CodeGenerator {
    ...
    private static final String JDBC_URL = "jdbc:mysql://localhost/yuntuan-server?useUnicode=true&characterEncoding=utf-8&useSSL=false&serverTimezone=Asia/Shanghai";
    ...
    public static void main(String[] args) {
        ...
        // 基类
        strategy.setSuperEntityClass(" com.yuntuan.server.support.BaseEntity");
        ...
        // package名
        pc.setParent(" com.yuntuan." + tableNames[0].subSequence(0, tableNames[0].indexOf('_')));
